...
export const Home: React.FC = () => {
  const typewriterText = ['Developer', 'Creator', 'Artist', 'Innovator'];
  ...
  return (
    ...
    >
      <div className="whiteSpace">
        <h1>{'<h1>Jesse Smith</h1>'}</h1>
        {/* <br/> */}
          <h2 className='typewriter'>&nbsp;</h2>
      </div>
     <div className='waveContainer'>
        {/* <svg style={{width: '200%'}}xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          <path fill="#eaf7cf" fill-opacity="1" d="M0,288L48,272C96,256,192,224,288,197.3C384,171,480,149,576,165.3C672,181,768,235,864,250.7C960,267,1056,245,1152,250.7C1248,256,1344,288,1392,304L1440,320L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
          <path className='testWave2'fill="#ffbc0a" fill-opacity="1" d="M0,288L48,272C96,256,192,224,288,197.3C384,171,480,149,576,165.3C672,181,768,235,864,250.7C960,267,1056,245,1152,250.7C1248,256,1344,288,1392,304L1440,320L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
          <path className='testWave2'fill="#fcbfb7" fill-opacity="1" d="M0,288L48,272C96,256,192,224,288,197.3C384,171,480,149,576,165.3C672,181,768,235,864,250.7C960,267,1056,245,1152,250.7C1248,256,1344,288,1392,304L1440,320L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
          <path className='testWave2'fill="#3f88c5" fill-opacity="1" d="M0,288L48,272C96,256,192,224,288,197.3C384,171,480,149,576,165.3C672,181,768,235,864,250.7C960,267,1056,245,1152,250.7C1248,256,1344,288,1392,304L1440,320L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
        </svg> */}
     ...
     {/* <div className='testWave2'>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        </svg>
     </div> */}
      {/* <div className="wave wave1" style={{height: '150px', overflow: 'hidden'}} >
        <svg viewBox="0 0 500 150" preserveAspectRatio="none" style={{height: '100%', width: '100%'}}>
          <path d="M0.00,92.27 C216.83,192.92 304.30,8.39 500.00,109.03 500.00,0.00 L0.00,0.00 Z" style={{stroke: 'none', fill: '#fcbfb7'}}></path>
        </svg>
      </div> */}
      {/* <div className="wave wave2">
        <svg viewBox="0 0 1000 150" preserveAspectRatio="none" style={{height: '200px', width: '5000px'}}>
          <path d="M0.00,92.27 C200.83,4000.92 2004.30,8.39 2000.00,109.03 L500.00,0.00 L.00,0.00 Z" style={{stroke: 'none', fill: '#eaf7cf'}}></path>
        </svg>
      </div>
      <div className="wave wave3">
        <svg viewBox="0 0 1000 150" preserveAspectRatio="none" style={{height: '200px', width: '5000px'}}>
          <path d="M0.00,92.27 C216.83,1000.92 304.30,8.39 700.00,109.03 L1000.00,0.00 L0.00,0.00 Z" style={{stroke: 'none', fill: '#fcbfb7'}}></path>
        </svg>
      </div>
      <div className="wave wave4">
        <svg viewBox="0 0 1000 150" preserveAspectRatio="none" style={{height: '200px', width: '5000px'}}>
          <path d="M0.00,92.27 C216.83,1000.92 304.30,8.39 700.00,109.03 L1000.00,0.00 L0.00,0.00 Z" style={{stroke: 'none', fill: '#ffbc0a'}}></path>
        </svg>
      </div> */}
      {/* <div className="wave wave1" style={{height: '200px', overflow: 'hidden'}}>
        <svg viewBox="0 0 1000 150" preserveAspectRatio="none" style={{height: '100%', width: '5000px'}}>
          <path d="M0.00,92.27 C216.83,192.92 304.30,8.39 500.00,109.03 L1000.00,0.00 L0.00,0.00 Z" style={{stroke: 'none', fill: '#ffffff'}}>
